      ...
      <section>
        ...
        <div className="chapterContrast content" id='chap1'>
          ...
          <div className="stepByStep">
            ...
            <p>
              No outro dia, vá ao quarto onde <span className="char Galvan"></span> e os demais estão reunidos. Um dos moradores diz que um aldeão foi atacado por um misterioso homem na floresta. <span className='char Galvan'></span> decide ir investigar.
            </p>
          </div>
